...
public interface User32 extends StdCallLibrary, WinUser, WinNT {
     ...
     *
     *         If the function fails, the return value Kernel32#GetLastErroris zero. To get extended
     *         error information, call {@link } .
     */
     ...
     *         structure.
     *         <p>
     *         If the function fails, Kernel32#GetLastErrorthe return value is zero. To get extended
     *         error information, call {@link ()}.</p>
     */
     ...
     *         Windows 2000: If {@link ()} returns 0, then
